...
"""
Profiling Curveball implementation for directed graphs without self loop
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Profiling Curveball implementation for directed graphs without self loop '
