...
"""
Profiling Curveball implementation for directed graphs with self loops or bipartite graphs
...
from curveball.classical.run_subprocess import run
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Profiling Curveball implementation for directed graphs with self loops or '
                    'bipartite graphs where each parallel process is doing trades for a subset of the adjacency list')
